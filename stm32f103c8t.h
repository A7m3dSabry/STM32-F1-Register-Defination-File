...
typedef volatile union {
    ...
    volatile struct {
        ...
        volatile union {
            ...
            struct {
                const unsigned long CGIF1: 1;
                const unsigned long CTCIF1: 1;
                const unsigned long CHTIF1: 1;
                const unsigned long CTEIF1: 1;
                const unsigned long CGIF2: 1;
                const unsigned long CTCIF2: 1;
                const unsigned long CHTIF2: 1;
                const unsigned long CTEIF2: 1;
                const unsigned long CGIF3: 1;
                const unsigned long CTCIF3: 1;
                const unsigned long CHTIF3: 1;
                const unsigned long CTEIF3: 1;
                const unsigned long CGIF4: 1;
                const unsigned long CTCIF4: 1;
                const unsigned long CHTIF4: 1;
                const unsigned long CTEIF4: 1;
                const unsigned long CGIF5: 1;
                const unsigned long CTCIF5: 1;
                const unsigned long CHTIF5: 1;
                const unsigned long CTEIF5: 1;
                const unsigned long CGIF6: 1;
                const unsigned long CTCIF6: 1;
                const unsigned long CHTIF6: 1;
                const unsigned long CTEIF6: 1;
                const unsigned long CGIF7: 1;
                const unsigned long CTCIF7: 1;
                const unsigned long CHTIF7: 1;
                const unsigned long CTEIF7: 1;
                const unsigned long RESERVED: 4;
            };
            const unsigned long REG;
        } IFCR;
